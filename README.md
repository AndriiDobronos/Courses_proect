CV_Course-project is a personal portfolio website built with React.js and Bootstrap,
utilizing React Router v6 to enable easy access to multiple pages.
...
Classic Design: The website has a modern and visually appealing design.
